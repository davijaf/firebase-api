package br.com.davijafcm.notificacoespush.logger
...
class AppLogger {
    ...
    @Pointcut("execution(* br.com.davijafcm.notificacoespush..services..*(..))")
    fun services() {
    }

    @Pointcut("execution(* br.com.davijafcm.notificacoespush.api..controllers..*(..))")
    fun restApi() {
    }
